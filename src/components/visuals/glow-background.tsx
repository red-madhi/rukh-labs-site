export function GlowBackground() {
  return (
      ...
      <div className="absolute right-[-16rem] top-1/3 h-[34rem] w-[34rem] rounded-full bg-[#124cff]/12 blur-3xl" />
      <div className="absolute bottom-[-20rem] left-[-12rem] h-[36rem] w-[36rem] rounded-full bg-[#6d31ff]/10 blur-3xl" />
