      ...
      <ul className="mt-5 grid gap-4">
        {sources.map((source) => (
          <li key={source.href} className="rounded-xl border border-white/10 bg-white/[0.02] p-4">
            <a href={source.href} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 font-medium text-[#9feaff] underline-offset-4 hover:underline focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-3 focus-visible:outline-[color:var(--brand-red)]">
