...
export const seoRoutes: readonly SeoRoute[] = [
  ...
  { path: "/work/rukh-labs-website", lastModified: SEO_PHASE_TWO_DEPLOYMENT_DATE, changeFrequency: "monthly", priority: 0.7, indexable: true, follow: true, classification: "indexable" },
  { path: "/work/farzin", lastModified: SEO_PHASE_TWO_DEPLOYMENT_DATE, changeFrequency: "monthly", priority: 0.1, indexable: false, follow: true, classification: "noindex-follow" },
  { path: "/work/glass-squares-os", lastModified: SEO_PHASE_TWO_DEPLOYMENT_DATE, changeFrequency: "monthly", priority: 0.1, indexable: false, follow: true, classification: "noindex-follow" },
  { path: "/work/career-portfolio-demo", lastModified: SEO_PHASE_TWO_DEPLOYMENT_DATE, changeFrequency: "monthly", priority: 0.7, indexable: true, follow: true, classification: "indexable" },
  { path: "/insights", lastModified: SEO_PHASE_TWO_DEPLOYMENT_DATE, changeFrequency: "monthly", priority: 0.8, indexable: true, follow: true, classification: "indexable" },
  { path: "/insights/small-business-website-cost-guide", lastModified: SEO_PHASE_TWO_DEPLOYMENT_DATE, changeFrequency: "monthly", priority: 0.8, indexable: true, follow: true, classification: "indexable" },
  ...
  { path: "/legal/privacy", lastModified: SEO_NETWORK_EXPLORER_DEPLOYMENT_DATE, changeFrequency: "yearly", priority: 0.3, indexable: true, follow: true, classification: "indexable" },
  ...
  { path: "/services/web-development/designs/atelier", lastModified: SEO_PHASE_TWO_DEPLOYMENT_DATE, changeFrequency: "yearly", priority: 0.5, indexable: true, follow: true, classification: "indexable" },
  { path: "/services/web-development/designs/main-street", lastModified: SEO_PHASE_TWO_DEPLOYMENT_DATE, changeFrequency: "yearly", priority: 0.5, indexable: true, follow: true, classification: "indexable" },
  { path: "/services/web-development/designs/spotlight", lastModified: SEO_PHASE_TWO_DEPLOYMENT_DATE, changeFrequency: "yearly", priority: 0.5, indexable: true, follow: true, classification: "indexable" },
  { path: "/services/web-development/designs/dispatch", lastModified: SEO_PHASE_TWO_DEPLOYMENT_DATE, changeFrequency: "yearly", priority: 0.5, indexable: true, follow: true, classification: "indexable" },
  { path: "/legal/terms", lastModified: SEO_PHASE_TWO_DEPLOYMENT_DATE, changeFrequency: "yearly", priority: 0.1, indexable: false, follow: true, classification: "noindex-follow" },
