...
export const metadata: Metadata = createPageMetadata({
  title: "IAZMA — Free Bluesky Network Discovery",
  description:
    "IAZMA is a free Bluesky network-discovery tool that analyzes followers or accounts followed, ranks people by network overlap and reach, and optionally lets you follow discoveries inside the tool.",
  path: "/tools/bluesky-network",
  image: {
    url: "/opengraph-image",
    width: 1200,
    height: 630,
    alt: "IAZMA by Rukh Labs",
  },
  keywords: [
    "IAZMA",
...
export default function BlueskyNetworkPage() {
  const structuredData = {
    ...
    description:
      "IAZMA is a free browser-based tool that analyzes public Bluesky follower or following connections, ranks second-degree accounts by network overlap and follower reach, and offers optional OAuth follow actions.",
    provider: {
      "@type": "Organization",
          ...
          <div className="max-w-5xl">
            ...
            <div className="mt-7 flex max-w-4xl flex-col gap-4 rounded-2xl border border-[#aa63ff]/22 bg-[radial-gradient(circle_at_100%_0%,rgba(170,99,255,0.13),transparent_42%),rgba(170,99,255,0.035)] p-4 sm:flex-row sm:items-center sm:justify-between sm:p-5">
              <div className="min-w-0">
                ...
                <p className="mt-2 text-sm font-semibold text-white">Want IAZMA to tell you who to cultivate next?</p>
                <p className="mt-1 text-xs leading-5 text-white/48">
                  Open IAZMA PRO for bridge strategy, follow-back tracking, evidence-weighted paths, action suggestions, network levels, and visual maps.
                </p>
              </div>
              <Link
        ...
        <Container className="max-w-5xl">
          <div className="flex flex-col gap-6 rounded-2xl border border-[#16c8ff]/20 bg-black/15 p-6 sm:p-8 lg:flex-row lg:items-center lg:justify-between">
            <div className="max-w-3xl">
              <Badge tone="gold">IAZMA PRO · Private beta</Badge>
              <h2 className="mt-4 text-2xl font-semibold text-white sm:text-3xl">
                Want IAZMA PRO to remember the network and tell you where to go next?
              </h2>
              <p className="mt-3 text-sm leading-7 text-white/56">
                IAZMA PRO adds persistent follow-back tracking, reciprocal path
                analysis, bridge and bestie discovery, targeted influential
      ...
      <Section className="border-t border-white/10">
        <Container className="max-w-4xl">
          <div className="rounded-2xl border border-white/10 bg-white/[0.02] p-5 text-sm leading-7 text-white/54 sm:p-7">
            ...
            <p className="mt-3">
              IAZMA recommends accounts, not posts. Follow relationships are
            ...
            <p className="mt-3">
              ...
              choose to follow an account inside IAZMA; Rukh Labs never asks
