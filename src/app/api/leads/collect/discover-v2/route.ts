...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    await finishCollector(runId, SOURCE_ID, candidates.length, found, { braveUsed, prioritizedContactable: true });
    return privateJson({ ok: true, source: SOURCE_ID, seen: candidates.length, qualified: found, stored: found, braveUsed });
  } catch (error) {
